...
final notificationsStreamProvider =
  ...
  return firestoreService.notificationsStream(user.id);
});
...
class _NotificationsScreenState extends ConsumerState<NotificationsScreen> {
  ...
  final _categories = [
    ...
    ('patient',     'Patients',     Icons.person_outlined),
            ...
            data: (items) {
              ...
              return TextButton(
                onPressed: user == null
                    ? null
                    : () async {
                        await firestoreService.markAllNotificationsRead(user.id);
                      },
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (_, i) => _NotificationCard(
                    ...
                    onTap: () async {
                      ...
                      if (id != null && filtered[i]['isRead'] != true) {
...
class _NotificationCard extends StatelessWidget {
  ...
  IconData get _icon {
    switch (notification['type']) {
      ...
      case 'patient':      return Icons.person_outlined;
  ...
  Color get _color {
    switch (notification['type']) {
      case 'commission':  return AppColors.secondary;
      case 'patient':     return AppColors.primary;
      case 'appointment': return AppColors.statusOPD;
        ...
        child: ListTile(
          ...
          subtitle: Column(
            ...
            children: [
              ...
              const SizedBox(height: 4),
              Text(
                AppFormatters.timeAgo(notification['createdAt']?.toString() ?? ''),
