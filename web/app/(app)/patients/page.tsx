  ...
  return (
    <div className="space-y-5">
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          ...
          <div className="relative flex-1">
            ...
            <input value={search} onChange={e => setSearch(e.target.value)}
              ...
              className="w-full border border-gray-200 rounded-xl pl-9 pr-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
            />
          </div>
          {/* Sort */}
      ...
      <div className="text-sm text-gray-500 font-medium">
        Showing <strong className="text-gray-800">{filtered.length}</strong> of {PATIENTS.length} patients
      </div>
      ...
      {filtered.length === 0 ? (
        <div className="bg-white rounded-2xl border border-gray-100 p-16 text-center">
          ...
          <div className="text-gray-500 text-sm">Try a different filter or search term</div>
        </div>
      ) : (
