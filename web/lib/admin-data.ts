...
export interface AdminPatient {
  ...
  opdScheduledAt?: string;    // ISO timestamp when OPD appointment scheduled
  opdToIpdAt?: string;        // ISO timestamp when patient converted from OPD to IPD
  ipdConfirmedAt?: string;    // ISO timestamp when IPD admission confirmed
...
export const ADMIN_PATIENTS: AdminPatient[] = [
  { id: 101, name: 'Ramesh Kumar', phone: '+91 98765 43210', age: 45, gender: 'M', specialty: 'Orthopaedics', procedure: 'Knee Replacement', status: 'ipd_confirmed', commission: 4500, commPct: 3.75, packageCost: 120000, city: 'Hyderabad', hospital: 'Apollo Hospitals', agentId: 'AG-HYD-001', agentName: 'Rajesh Sharma', createdAt: '10 May 2024', contactedAt: '2024-05-11T10:30:00', contactMethod: 'call', opdScheduledAt: '2024-05-14T09:00:00', opdToIpdAt: '2024-05-16T14:00:00', ipdConfirmedAt: '2024-05-16T16:30:00', conversionDays: 6 },
  { id: 102, name: 'Priya Sharma', phone: '+91 97654 32109', age: 35, gender: 'F', specialty: 'Urology', procedure: 'Stone Removal', status: 'opd_scheduled', commission: 3900, commPct: 4.0, packageCost: 80000, city: 'Bangalore', hospital: 'Manipal Hospital', agentId: 'AG-HYD-001', agentName: 'Rajesh Sharma', createdAt: '12 May 2024', contactedAt: '2024-05-13T09:15:00', contactMethod: 'whatsapp', opdScheduledAt: '2024-05-22T10:30:00' },
  ...
  { id: 104, name: 'Meena Devi', phone: '+91 95432 10987', age: 28, gender: 'F', specialty: 'Gynecology', procedure: 'Laparoscopy', status: 'contacted', commission: 2800, commPct: 4.0, packageCost: 70000, city: 'Mumbai', hospital: 'Kokilaben Hospital', agentId: 'AG-HYD-001', agentName: 'Rajesh Sharma', createdAt: '20 May 2024', contactedAt: '2024-05-21T11:45:00', contactMethod: 'call' },
  { id: 105, name: 'Vijay Patel', phone: '+91 94321 09876', age: 60, gender: 'M', specialty: 'General Surgery', procedure: 'Gallbladder Removal', status: 'completed', commission: 3200, commPct: 4.0, packageCost: 80000, city: 'Delhi', hospital: 'Fortis Hospital', agentId: 'AG-HYD-001', agentName: 'Rajesh Sharma', createdAt: '22 Apr 2024', contactedAt: '2024-04-23T08:20:00', contactMethod: 'call', opdScheduledAt: '2024-04-24T11:00:00', opdToIpdAt: '2024-04-25T13:30:00', ipdConfirmedAt: '2024-04-25T14:45:00', conversionDays: 3 },
  ...
  { id: 107, name: 'Arjun Nair', phone: '+91 88765 43210', age: 38, gender: 'M', specialty: 'Cardiology', procedure: 'Bypass Surgery', status: 'ipd_confirmed', commission: 12000, commPct: 3.5, packageCost: 350000, city: 'Bangalore', hospital: 'Narayana Health', agentId: 'AG-BLR-001', agentName: 'Preethi Nair', createdAt: '8 May 2024', contactedAt: '2024-05-09T10:00:00', contactMethod: 'call', opdScheduledAt: '2024-05-12T14:00:00', opdToIpdAt: '2024-05-14T15:45:00', ipdConfirmedAt: '2024-05-14T17:20:00', conversionDays: 6 },
  { id: 108, name: 'Lakshmi Iyer', phone: '+91 87654 32109', age: 55, gender: 'F', specialty: 'Gynecology', procedure: 'Hysterectomy', status: 'opd_scheduled', commission: 4900, commPct: 3.5, packageCost: 140000, city: 'Bangalore', hospital: 'Manipal Hospital', agentId: 'AG-BLR-001', agentName: 'Preethi Nair', createdAt: '14 May 2024', contactedAt: '2024-05-15T14:20:00', contactMethod: 'whatsapp', opdScheduledAt: '2024-05-25T09:30:00' },
  { id: 109, name: 'Mohammed Irfan', phone: '+91 86543 21098', age: 48, gender: 'M', specialty: 'Neurology', procedure: 'Brain Tumour Surgery', status: 'completed', commission: 18000, commPct: 4.0, packageCost: 450000, city: 'Mumbai', hospital: 'Kokilaben Hospital', agentId: 'AG-MUM-001', agentName: 'Amit Patel', createdAt: '2 Apr 2024', contactedAt: '2024-04-03T09:30:00', contactMethod: 'call', opdScheduledAt: '2024-04-04T10:00:00', opdToIpdAt: '2024-04-05T16:00:00', ipdConfirmedAt: '2024-04-05T17:30:00', conversionDays: 3 },
  { id: 110, name: 'Seema Kapoor', phone: '+91 85432 10987', age: 32, gender: 'F', specialty: 'Orthopaedics', procedure: 'Hip Replacement', status: 'ipd_confirmed', commission: 6800, commPct: 4.0, packageCost: 170000, city: 'Delhi', hospital: 'Max Hospital', agentId: 'AG-DEL-001', agentName: 'Sunita Verma', createdAt: '10 May 2024', contactedAt: '2024-05-11T11:00:00', contactMethod: 'whatsapp', opdScheduledAt: '2024-05-13T15:00:00', opdToIpdAt: '2024-05-17T12:15:00', ipdConfirmedAt: '2024-05-17T13:45:00', conversionDays: 7 },
  { id: 111, name: 'Ganesh Babu', phone: '+91 84321 09876', age: 65, gender: 'M', specialty: 'Cardiology', procedure: 'Valve Replacement', status: 'contacted', commission: 15000, commPct: 3.75, packageCost: 400000, city: 'Chennai', hospital: null, agentId: 'AG-CHN-001', agentName: 'Karthik Raja', createdAt: '15 May 2024', contactedAt: '2024-05-16T13:45:00', contactMethod: 'call' },
  ...
  { id: 113, name: 'Santosh Desai', phone: '+91 82109 87654', age: 50, gender: 'M', specialty: 'Urology', procedure: 'Prostate Surgery', status: 'opd_scheduled', commission: 5200, commPct: 3.5, packageCost: 148000, city: 'Pune', hospital: 'Ruby Hall Clinic', agentId: 'AG-PNE-001', agentName: 'Meera Joshi', createdAt: '17 May 2024', contactedAt: '2024-05-18T10:30:00', contactMethod: 'sms', opdScheduledAt: '2024-05-23T11:00:00' },
  { id: 114, name: 'Anita Rao', phone: '+91 81098 76543', age: 44, gender: 'F', specialty: 'General Surgery', procedure: 'Appendectomy', status: 'completed', commission: 2100, commPct: 4.0, packageCost: 52000, city: 'Hyderabad', hospital: 'Yashoda Hospital', agentId: 'AG-HYD-002', agentName: 'Ravi Kumar', createdAt: '5 Apr 2024', contactedAt: '2024-04-06T09:00:00', contactMethod: 'call', opdScheduledAt: '2024-04-07T10:30:00', opdToIpdAt: '2024-04-08T11:30:00', ipdConfirmedAt: '2024-04-08T12:45:00', conversionDays: 3 },
  { id: 115, name: 'Rohit Malhotra', phone: '+91 80987 65432', age: 37, gender: 'M', specialty: 'Gastroenterology', procedure: 'Colonoscopy + Polypectomy', status: 'ipd_confirmed', commission: 3800, commPct: 4.0, packageCost: 95000, city: 'Hyderabad', hospital: 'KIMS Hospital', agentId: 'AG-HYD-002', agentName: 'Ravi Kumar', createdAt: '12 May 2024', contactedAt: '2024-05-13T15:20:00', contactMethod: 'whatsapp', opdScheduledAt: '2024-05-16T09:00:00', opdToIpdAt: '2024-05-19T10:45:00', ipdConfirmedAt: '2024-05-19T12:30:00', conversionDays: 7 },
];
